...
<?php
	...
	case 1:
		...
		if ( $error === false ) {
			...
			// autofill.inc.php
			$autofill_file = file( ABSPATH . 'manage/include/autofill.inc.default.php' );
			...
			unset( $line );
			$autofill_new = ABSPATH . 'manage/include/autofill.inc.php';
			...
			copy(ABSPATH . 'manage/include/gnupg.inc.default.php', ABSPATH . 'manage/include/gnupg.inc.php');

			if ( file_exists(ABSPATH.'manage/include/config.inc.php') && file_exists(ABSPATH.'manage/include/gnupg.inc.php') && file_exists(ABSPATH.'manage/include/autofill.inc.php') ){
				chmod( $autofill_new, 0666 );
				chmod( $config_new, 0666 );
				chmod( ABSPATH . 'manage/include/gnupg.inc.php', 0666 );
?>
...
<p><?php _e( 'DCRM has been installed, but some files have not been copied. Please copy all <code>*.inc.default.php</code> to <code>*.inc.php</code> in <code>/manage/include/</code> and chmod to 0666.' ); ?></p>
<?php
			}
?>
