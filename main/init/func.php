<?php
// 设定绝对目录
$root = str_replace('/init/', '', str_replace('\\', '/', dirname(__FILE__).'/')).'/';
define('ABSPATH', $root);
unset( $root );
...
function base_url(){
	...
	$base_url = str_replace('/init/', '', $base_url.'/');
	...
	if( $notice == '' ){
		if( $install == false ){
			if (file_exists(ABSPATH.'manage/include/connect.inc.php')) {
				$notice = '<strong>'.__('Warning: ').'</strong>'.__('The file \'/manage/include/connect.inc.php\' already exists. If you need to reset any of the configuration items in this file, please delete it first.');
			} elseif (!file_exists(ABSPATH.'manage/include/connect.inc.default.php')) {
				$notice = '<strong>'.__('Warning: ').'</strong>'.__('Sorry, I need a /manage/include/connect.inc.default.php file to work from. Please re-upload this file from your DCRM installation.');
			} elseif (!is_writable(ABSPATH.'manage/include/')) {
				$notice = '<strong>'.__('Warning: ').'</strong>'.__('<code>/manage/include/</code> directory is not writable. Please change the directory properties or create the connect.inc.php manually (you can see connect.inc.default.php)');
			}
		} else {
			if (!file_exists(ABSPATH.'manage/include/config.inc.default.php')) {
				$notice = '<strong>'.__('Warning: ').'</strong>'.__('Sorry, I need a /manage/include/config.inc.default.php file to work from. Please re-upload this file from your DCRM installation.');
			} elseif (!file_exists(ABSPATH.'manage/include/gnupg.inc.default.php')) {
				$notice = '<strong>'.__('Warning: ').'</strong>'.__('Sorry, I need a /manage/include/gnupg.inc.default.php file to work from. Please re-upload this file from your DCRM installation.');
			} elseif (!file_exists(ABSPATH.'manage/include/autofill.inc.default.php')) {
				$notice = '<strong>'.__('Warning: ').'</strong>'.__('Sorry, I need a /manage/include/autofill.inc.default.php file to work from. Please re-upload this file from your DCRM installation.');
			} elseif (!is_writable(ABSPATH.'manage/include/')) {
				$notice = '<strong>'.__('Warning: ').'</strong>'.__('<code>/manage/include/</code> directory is not writable. Please change the directory properties.');
			}
		}
	}
	return $notice;
