...
switch($step) {
	...
	<p><strong><?php _e('If for any reason you can&#8217;t enter next step, don&#8217;t worry. All this does is fill in the database information to a configuration file. You may also simply open <code>/manage/include/connect.inc.default.php</code> in a text editor, fill in your information, and save it as <code>connect.inc.php</code>.'); ?></strong></p>
...
<?
	...
	case 3:
		...
		$config_file = file( ABSPATH . 'manage/include/connect.inc.default.php' );
		...
		$path_to_config = ABSPATH . 'manage/include/connect.inc.php';
