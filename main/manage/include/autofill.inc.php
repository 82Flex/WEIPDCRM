<?php
	...
	define("AUTOFILL_MASTER","i_82");
	define("AUTOFILL_FULLNAME","威锋网测试组 i_82");
	define("AUTOFILL_EMAIL","i.82@me.com");
	define("AUTOFILL_SITE","http://82flex.com");
	define("AUTOFILL_WEIBO","http://m.weibo.cn/u/5221259723");
	define("AUTOFILL_WEIBO_NAME","82Flex");
	define("AUTOFILL_DESCRIPTION","一个萌萌哒软件包。");
	define("AUTOFILL_SEO","82Flex 中文源");
	define("AUTOFILL_KEYWORDS","iPhone, iPad, iPod Touch, Tweaks, 越狱, 插件, 测试, 82Flex, 软件源");
	...
	define("AUTOFILL_ADVERTISEMENT", "<a href=\"cydia://package/com.darwindev.touchsprite\" id=\"advertisement\">\n\t<img src=\"http://www.touchsprite.com/adv/02.jpg\" alt=\"触动精灵\" width=\"264\" height=\"176\" />\n</a>");
?>