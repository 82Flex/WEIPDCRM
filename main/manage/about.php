...
?>
					...
					<?php _e('UI Design:'); ?><a href="http://weibo.com/1921596413">@大蝦酥CAMZ</a><?php _ex(', ' , 'Punctuation'); ?><a href="http://weibo.com/hintay">@Hintay</a><br /><br />
					<h4><?php _e('Credits'); ?></h4>
					<?php _e('WeiPhone'); ?> <a href="http://weibo.cn/375584554">@飄Sir</a> <?php _ex('support' , 'Credits'); ?><br />
					<?php _e('E-pal'); ?> <a href="http://weibo.com/u/1766730601">@zsm1703</a><?php _ex(', ' , 'Punctuation'); ?><a href="http://weibo.com/u/2175594103">@Naville</a><?php _ex(', ' , 'Punctuation'); ?><a href="http://weibo.com/u/1931192555">@Q某某某某</a><?php _ex(', ' , 'Punctuation'); ?><a href="http://weibo.com/u/3254325910">@摇滚米饭_</a><br />
					...
					<?php _e('Also, and the father of the Cydia™'); ?> <a href="http://www.saurik.com">Saurik</a><?php _e('\'s articles: '); ?><a href="http://www.saurik.com/id/7">How to host a Cydia™ Repository</a><br/>
					...
					<br /><br />
					<h4><?php _e('Copyright'); ?>© 2013–<?php echo date('Y'); ?> 82FLEX &amp; Hintay<br />
